...
/**
 * REST controller for managing {@link io.akhilennu.chatbot.domain.ChatMessage}.
 */
@RestController
...
public class ChatMessageResource {
    ...
    public ResponseEntity<ChatMessageDTO> createChatMessage(@Valid @RequestBody ChatMessageDTO chatMessageDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/chat-messages/" + chatMessageDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, chatMessageDTO.getId().toString()))
            .body(chatMessageDTO);
    }
    ...
    public ResponseEntity<ChatMessageDTO> updateChatMessage(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, chatMessageDTO.getId().toString()))
            .body(chatMessageDTO);
    }
    ...
    public ResponseEntity<ChatMessageDTO> partialUpdateChatMessage(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, chatMessageDTO.getId().toString())
        );
    }
