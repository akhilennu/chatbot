...
public class IntentEntityResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<IntentEntityDTO> createIntentEntity(@RequestBody IntentEntityDTO intentEntityDTO) throws URISyntaxException {
    ...
    public ResponseEntity<IntentEntityDTO> updateIntentEntity(
        ...
        @RequestBody IntentEntityDTO intentEntityDTO
     ...
     */
    @GetMapping("")
    public List<IntentEntityDTO> getAllIntentEntities() {
        LOG.debug("REST request to get all IntentEntities");
        return intentEntityService.findAll();
    }
