...
public class UtteranceResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<UtteranceDTO>> getAllUtterances(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        LOG.debug("REST request to get a page of Utterances");
        Page<UtteranceDTO> page = utteranceService.findAll(pageable);
