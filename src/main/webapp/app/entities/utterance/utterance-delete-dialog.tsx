...
export const UtteranceDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/utterance${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="chatbotApp.utterance.delete.question">Are you sure you want to delete Utterance {utteranceEntity.id}?</ModalBody>
      <ModalFooter>
