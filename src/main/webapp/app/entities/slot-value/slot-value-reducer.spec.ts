...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SLOTVALUE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SLOTVALUE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SLOTVALUE actions', async () => {
      const arg = { id: 3842 };
    ...
    it('dispatches UPDATE_SLOTVALUE actions', async () => {
      const arg = { id: 3842 };
    ...
    it('dispatches PARTIAL_UPDATE_SLOTVALUE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SLOTVALUE actions', async () => {
      const arg = 42666;
