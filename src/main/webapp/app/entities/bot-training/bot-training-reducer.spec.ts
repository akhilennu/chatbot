...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOTTRAINING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOTTRAINING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOTTRAINING actions', async () => {
      const arg = { id: 26835 };
    ...
    it('dispatches UPDATE_BOTTRAINING actions', async () => {
      const arg = { id: 26835 };
    ...
    it('dispatches PARTIAL_UPDATE_BOTTRAINING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOTTRAINING actions', async () => {
      const arg = 42666;
