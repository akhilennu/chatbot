...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UTTERANCEINTENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_UTTERANCEINTENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_UTTERANCEINTENT actions', async () => {
      const arg = { id: 32076 };
    ...
    it('dispatches UPDATE_UTTERANCEINTENT actions', async () => {
      const arg = { id: 32076 };
    ...
    it('dispatches PARTIAL_UPDATE_UTTERANCEINTENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_UTTERANCEINTENT actions', async () => {
      const arg = 42666;
