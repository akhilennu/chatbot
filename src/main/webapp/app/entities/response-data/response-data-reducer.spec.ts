...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESPONSEDATA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RESPONSEDATA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RESPONSEDATA actions', async () => {
      const arg = { id: 1451 };
    ...
    it('dispatches UPDATE_RESPONSEDATA actions', async () => {
      const arg = { id: 1451 };
    ...
    it('dispatches PARTIAL_UPDATE_RESPONSEDATA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RESPONSEDATA actions', async () => {
      const arg = 42666;
