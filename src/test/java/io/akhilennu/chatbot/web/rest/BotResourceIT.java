...
class BotResourceIT {
    ...
    public static Bot createEntity() {
        return new Bot().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION);
    }
    ...
    public static Bot createUpdatedEntity() {
        return new Bot().name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
    }
    ...
    void putExistingBot() throws Exception {
        ...
        updatedBot.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateBotWithPatch() throws Exception {
        ...
        partialUpdatedBot.description(UPDATED_DESCRIPTION);
