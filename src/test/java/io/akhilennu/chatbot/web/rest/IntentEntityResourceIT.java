...
class IntentEntityResourceIT {
    ...
    public static IntentEntity createEntity() {
        return new IntentEntity().entityName(DEFAULT_ENTITY_NAME);
    }
    ...
    public static IntentEntity createUpdatedEntity() {
        return new IntentEntity().entityName(UPDATED_ENTITY_NAME);
    }
    ...
    void putExistingIntentEntity() throws Exception {
        ...
        updatedIntentEntity.entityName(UPDATED_ENTITY_NAME);
    ...
    void fullUpdateIntentEntityWithPatch() throws Exception {
        ...
        partialUpdatedIntentEntity.entityName(UPDATED_ENTITY_NAME);
